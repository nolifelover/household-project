  ...
  <body>
    <div class="box">
      <div class="header">
        ...
        <g:message code="moo.all.title" args="${[params.moo, params.tumbon, params.district, params.province]}"/>
      </div>
      <div class="body">
        <div class="clearfix">
          ...
          <table cellpadding="0" cellspacing="0" border="0" class="nopage display">
            ...
            <g:each in="${histories}" status="i" var="history">
              <tr class="gradeA ${(i % 2) == 0 ? 'odd' : 'even'}">
                ...
                <td><g:link controller="sumarize" action="mooDetail" params="${[moo: params.moo, tumbon: params.tumbon, district: params.district, province: params.province, month: history.month]}">${message(code:"income.detail")}</g:link></td>
              </tr>
            </g:each>
            </tbody>
          </table>
